           ...
           <input name="multi_image" class="form-control" type="file" id="image" >
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
  <img id="showImage" class="rounded avatar-lg" src="{{ asset('storage/'.$multiimage->multi_image)  }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
<input type="submit" class="btn btn-info waves-effect waves-light" value="Update Multi Image">
<a href="{{  route('all.multi.image') }}" class="btn btn-info">Cancle</a>
            </form>
