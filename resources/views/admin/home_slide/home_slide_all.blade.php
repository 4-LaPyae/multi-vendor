       ...
       <input name="home_slide" class="form-control" type="file"  id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($homeslide->home_slide))? url('storage/'.$homeslide->home_slide):url('storage/profile_image.Preworkscreen COVID-19 Screening Default Avatar.png') }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
